...
-- Usuario de ejemplo para ingresar al sistema: Administrador
-- Contraseña: Administrador
-- Servidor: localhost:3306
-- Usuario: root
-- Contraseña: vacia
-- Tiempo de generación: 11-10-2024 a las 8:45:03
-- Versión del servidor: 10.4.28-MariaDB
-- Versión de PHP: PHP Version 8.2.4
...
CREATE TABLE `usuario` (
  ...
  `usuario_nombre` varchar(70) COLLATE utf8_spanish_ci NOT NULL,
  `usuario_apellido` varchar(70) COLLATE utf8_spanish_ci NOT NULL,
  `usuario_email` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `usuario_usuario` varchar(30) COLLATE utf8_spanish_ci NOT NULL,
  `usuario_clave` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `usuario_foto` varchar(535) COLLATE utf8_spanish_ci NOT NULL,
